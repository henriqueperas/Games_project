...
public class Enemy extends Entity{
	...
	//private int maskx = 2,masky = 5,maskw = 13,maskh = 11;
	...
	public Enemy(int x, int y, int width, int height, BufferedImage sprite) {
		...
		for(int i = 0; i < 3; i++) {
		sprites[i] = Game.spritesheet.getSprite(112 + (i*16), 32,16,16);
		}
		/*for(int i = 0; i < 2; i++) {
		sprites[i] = Game.spritesheet.getSprite(112 + (i*16), 32,16,16);
		}*/
	...
	public void tick(){
		...
		if(this.calculateDistance(this.getX(), this.getY(), Game.player.getX(), Game.player.getY()) < 125) {
