...
public class Entity {
	...
	public static BufferedImage ENEMY_FEEDBACK = Game.spritesheet.getSprite(112, 64, 16, 16);
	...
	public static BufferedImage GUN_DOWN = Game.spritesheet.getSprite(112, 16, 16, 16);
