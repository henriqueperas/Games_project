...
public class Entity {
	...
	public static BufferedImage DOCE_SPRITE = Game.spritesheet.getSprite(0, 16, 16, 16);
	public static BufferedImage BALA_SPRITE = Game.spritesheet.getSprite(0, 32, 16, 16);
	public static BufferedImage ENEMY1 = Game.spritesheet.getSprite(144, 0, 16, 16);
	public static BufferedImage ENEMY2 = Game.spritesheet.getSprite(144, 16, 16, 16);
	public static BufferedImage ENEMY3 = Game.spritesheet.getSprite(144, 32, 16, 16);
	public static BufferedImage ENEMY4 = Game.spritesheet.getSprite(144, 48, 16, 16);
	public static BufferedImage ENEMY5 = Game.spritesheet.getSprite(144, 64, 16, 16);
	public static BufferedImage ENEMYGHOST = Game.spritesheet.getSprite(176, 80, 16, 16);
