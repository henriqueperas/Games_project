...
public class Game extends Canvas implements Runnable,KeyListener,MouseListener,MouseMotionListener{
	...
	public Game() {
		...
		player = new Player(0,0,16,16, 2,Entity.PLAYER_SPRITE_RIGHT);
	...
	public void render() {
		...
		g.setColor(new Color(22,113,204));
	...
	public void keyPressed(KeyEvent e) {
		...
		if(!World.isFree(player.getX(), (int) (player.y+player.speed))) {
			if(e.getKeyCode() == KeyEvent.VK_SPACE) {
				player.jump = true;
				player.jumpTime = true;
			}
		}
	}
