...
public class Entity {
	...
	public static BufferedImage ENEMY1_RIGHT = Game.spritesheet.getSprite(96, 32, 16, 16);
	public static BufferedImage ENEMY1_LEFT = Game.spritesheet.getSprite(112, 32, 16, 16);
